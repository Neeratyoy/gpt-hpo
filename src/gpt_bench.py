...
from data.data_prep_tinyshakespeare import extract_vocab_and_data, prepare_shakespeare
from src.search_space import get_charLM_space_large, get_charLM_space_small
from src.utils import load_config
from src.run_skeletal import run
...
class CharLMBench:
    def __init__(
        ...
        self.data_path = self.check_input_path(self.data_path)
    ...
    def check_input_path(self, data_path: Path) -> Path:
